...
public class Places extends Activity implements OnItemClickListener {
    ...
    private void fetchPlaces() {
        if (!isFinishing()) {
            dialog = ProgressDialog.show(Places.this, "", "Nearby", true,
        ...
        FacebookSocialNetwork facebookSocialNetwork = new FacebookSocialNetwork(Phlogit.getPhlogitApplicationContext());
        facebook = new Facebook(
				Configuration.getFacebookAuthKey());
		String accessToken = facebookSocialNetwork.getToken();
		long expires = facebookSocialNetwork.getExpires();
		if (accessToken != null)
        ...
        public void onComplete(final String response, final Object state) {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    TextView v = new TextView(Places.this);
                	v.setText("Select a place to Check-In");
                    v.setGravity(Gravity.CENTER_HORIZONTAL);
                	placesList.addHeaderView(v);
    ...
    public void onItemClick(AdapterView<?> arg0, View v, int position, long arg3) {
        if (!facebook.isSessionValid()) {
            ...
            try {
                ...
                final String name = jsonArray.getJSONObject(position-1).getString("name");
                final String placeID = jsonArray.getJSONObject(position-1).getString("id");
                new AlertDialog.Builder(this).setTitle("Check-In")
                        .setMessage("Check-In at "+name)
